...
Watchtower/
  ...
  backend/                Express API for users, sessions, and course search
  database/               PostgreSQL schema, Docker Compose, and DB docs
  scheduler/              Python FastAPI scheduler and MaxSAT solver pipeline
  scraper/                Rust scraper CLI/API for course and section data
  parser/                 Spring Boot DegreeWorks PDF parser
  docs/
    architecture/         Structurizr C4 workspace and generated diagrams
    citations/            Project citation files
