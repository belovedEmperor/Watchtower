...
Use `scheduler/examples/generate_schedule_request.json` as the current UI/parser integration sample. It mirrors the `LANGUAGE_SYMBOLIC_PARSER_PAYLOAD` and `LANGUAGE_SYMBOLIC_UI_PAYLOAD` fixtures in `scheduler/fixtures/test_profiles.py`.
